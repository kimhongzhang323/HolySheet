...
export default function TicketCard({ category, title, date, time, id, imageGradient }: TicketProps) {
    return (
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 flex p-0 overflow-hidden relative group hover:shadow-md transition-shadow">
            {/* Left Image Section */}
            <div className={`w-28 bg-gradient-to-br ${imageGradient} relative`}>
